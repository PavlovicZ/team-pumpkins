...
public class Floor3Activity extends ParentFloorActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFloor = getIntent().getIntExtra(EXTRA_FLOOR, 3);
        ...
        mGrabBlacklightButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //H. Ben Reed
                mGrabBlacklightButton.setEnabled(false);
                mGrabBlacklightButton.setVisibility(View.INVISIBLE);

                updateToolbar();

                mBlacklightButton.setEnabled(true);
            }
        });
       ...
       /*mNoteButton = (ImageButton) findViewById(R.id.note_button);
        ...
        mNoteButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Floor3Activity.this, MenuActivity.class);
                i.putExtra(EXTRA_FLOOR, 3);
                startActivity(i);
            }
        });

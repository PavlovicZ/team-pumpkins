    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGrabLockpickButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //H. Ben Reed
                mGrabLockpickButton.setEnabled(false);
                mGrabLockpickButton.setVisibility(View.INVISIBLE);
                updateToolbar();
                mLockpickButton.setEnabled(true);
            }
        });
       ...
       /*mNoteButton = (ImageButton) findViewById(R.id.note_button);
        ...
        mBackground4 = (ImageView) findViewById(R.id.floor4);
        ...
        mKeyButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mKeyButton.isEnabled()) {
                    mBackground4.setImageDrawable(getResources().getDrawable(R.drawable.ic_maintenance_open));
                    if (mLockpickHeld == false){
                        mGrabLockpickButton.setVisibility(View.VISIBLE);
                        mGrabLockpickButton.setEnabled(true);
                    }
                }
            }
        });
